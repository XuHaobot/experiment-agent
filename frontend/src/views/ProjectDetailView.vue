...
const I18N_DICT = {
  'en-US': {
    ...
    overview: {
      ...
      nextActionBadge: 'Next Research Action',
      nextActionTitle: 'No pending experiment action',
      nextActionReason: 'Propose hypotheses and create experimental protocols to generate automated next-step recommendations.',
  ...
  'zh-CN': {
    ...
    overview: {
      ...
      bestAccuracy: '最高准确率:',
      computeSpent: '已消耗算力:',
      nextActionBadge: '下一步研究行动',
      nextActionTitle: '暂无待审批行动',
      nextActionReason: '在「科学假说」中提出假说或在「实验方案」中创建基线实验后，系统将自动生成下一步推演行动建议。',
      recommendedK: '推荐 k 值:',
      learningRate: '学习率:',
      infoGain: '信息增益:',
      highGain: '极大',
